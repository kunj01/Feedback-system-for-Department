...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800">Create New Placement</h1>
</div>
            ...
            <form method="POST" action="{{ route('placements.store') }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="job_title" name="job_title" value="{{ old('job_title') }}" placeholder="e.g., Software Engineer" class="input-field @error('job_title') border-red-500 @enderror" required>
                        @error('job_title')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="placement_type" name="placement_type" class="input-field @error('placement_type') border-red-500 @enderror" required>
                                ...
                                <option value="Full-Time" {{ old('placement_type', 'Full-Time') == 'Full-Time' ? 'selected' : '' }}>Full-Time</option>
                                <option value="Internship" {{ old('placement_type') == 'Internship' ? 'selected' : '' }}>Internship</option>
                                <option value="Part-Time" {{ old('placement_type') == 'Part-Time' ? 'selected' : '' }}>Part-Time</option>
                                <option value="Contract" {{ old('placement_type') == 'Contract' ? 'selected' : '' }}>Contract</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" id="package_lpa" name="package_lpa" value="{{ old('package_lpa') }}" step="0.01" min="0" placeholder="0.00" class="input-field @error('package_lpa') border-red-500 @enderror" required>
                            @error('package_lpa')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="location" name="location" value="{{ old('location') }}" placeholder="e.g., Mumbai, Bangalore" class="input-field @error('location') border-red-500 @enderror">
                            @error('location')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" id="offer_date" name="offer_date" value="{{ old('offer_date', date('Y-m-d')) }}" class="input-field @error('offer_date') border-red-500 @enderror">
                            @error('offer_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="joining_date" name="joining_date" value="{{ old('joining_date') }}" class="input-field @error('joining_date') border-red-500 @enderror">
                            @error('joining_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Role responsibilities, requirements..." class="input-field @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-3 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <a href="{{ route('placements.index') }}" class="btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
