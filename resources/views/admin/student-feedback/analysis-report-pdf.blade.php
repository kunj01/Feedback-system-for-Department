...
<body>
    <!-- Header -->
    <div class="header">
        <h1>{{ $analysis['title_info']['institute'] }}</h1>
        <h2>Analysis of Student Feedback</h2>
    ...
    <div class="section">
        ...
        <div class="subsection-title">Section 1: Student Experience</div>
        <table>
            <thead>
                <tr>
        ...
        <div class="subsection-title">Section 2: Instructor Experience</div>
        <table>
            <thead>
                <tr>
                    <th style="width: 35%;">Question</th>
        ...
        <div class="subsection-title">Section 3: Course Content</div>
        <table>
            <thead>
                <tr>
                    <th style="width: 35%;">Question</th>
    ...
    <div class="footer">
        ...
        <p>{{ $analysis['title_info']['institute'] }} - Academic Year {{ $analysis['title_info']['academic_year'] }}</p>
    </div>
</body>
</html>
